...
var findElement = function findElement(ref, selector) {
  if (!ref) return;
  return ref.querySelector("#cloudcomputing_svg__".concat(selector));
};

var CloudComputingAnimation = function CloudComputingAnimation() {
  ...
  (0, _react.useEffect)(function () {
    ...
    animation.current.add(_all.TweenMax.to(cloud, timing, {
      y: 7,
      opacity: 0.6,
      easing: _all.Power1.easeInOut
    })).add(_all.TweenMax.to(line1, timing, {
      y: 15,
      easing: _all.Power1.easeInOut
    }), offset).add(_all.TweenMax.to(line2, timing, {
      y: 15,
      easing: _all.Power1.easeInOut
